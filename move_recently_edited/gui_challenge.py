...
class ParentWindow(Frame):
    def __init__(self, master, *args, **kwargs):
        ...
        self.btn_checkFiles = Button(self.master, text = "Move Files", width = 12, height = 2, command=lambda:shutil_challenge.move_files(self.txt_browse1.get(), self.txt_browse2.get()))
